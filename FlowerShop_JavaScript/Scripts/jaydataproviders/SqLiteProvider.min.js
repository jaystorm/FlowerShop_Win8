...
version:"",displayName:this.providerConfiguration.displayName,maxSize:this.providerConfiguration.maxSize,storage:this.providerConfiguration.storage};if(this.connection)return this.connection;var b=null;return this.connection=b=this.providerConfiguration.storage?new $data.dbClient.jayStorageClient.JayStorageConnection(a):"undefined"!==typeof sqLiteModule?new $data.dbClient.sqLiteNJClient.SqLiteNjConnection(a):new $data.dbClient.openDatabaseClient.OpenDbConnection(a)},supportedDataTypes:{value:[$data.Integer,
$data.String,$data.Number,$data.Blob,$data.Boolean,$data.Date,$data.Guid],writable:!1},fieldConverter:{value:{fromDb:{"$data.Integer":function(a){return a},"$data.Number":function(a){return a},"$data.Date":function(a){return null!=a?new Date(a):a},"$data.String":function(a){return a},"$data.Boolean":function(a){return 1===a?!0:!1},"$data.Blob":function(a){return a},"$data.Guid":function(a){return a?$data.parseGuid(a):a}},toDb:{"$data.Integer":function(a){return a},"$data.Number":function(a){return a},
"$data.Date":function(a){return a?a.valueOf():null},"$data.String":function(a){return a},"$data.Boolean":function(a){return a?1:0},"$data.Blob":function(a){return a},"$data.Guid":function(a){return a?a.value:a},"$data.Object":function(a){if(null===a)return null;throw"Not supported exception";}}}},supportedFieldOperations:{value:{length:{dataType:"number",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.ProjectionExpression]},substr:{dataType:"string",allowedIn:$data.Expressions.FilterExpression,
parameters:[{name:"startFrom",dataType:"number"},{name:"length",dataType:"number"}]},toLowerCase:{dataType:"string",mapTo:"lower"},toUpperCase:{dataType:"string",mapTo:"upper"},contains:{mapTo:"like",dataType:"boolean",allowedIn:$data.Expressions.FilterExpression,parameters:[{name:"strFragment",dataType:"string",prefix:"%",suffix:"%"}]},startsWith:{mapTo:"like",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.ProjectionExpression],parameters:[{name:"strFragment",
dataType:"string",suffix:"%"}]},endsWith:{mapTo:"like",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.ProjectionExpression],parameters:[{name:"strFragment",dataType:"string",prefix:"%"}]},trim:{dataType:$data.String,allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.ProjectionExpression],mapTo:"trim",parameters:[{name:"@expression",dataType:$data.String},{name:"chars",dataType:$data.String}]},ltrim:{dataType:$data.String,allowedIn:[$data.Expressions.FilterExpression,
$data.Expressions.ProjectionExpression],mapTo:"ltrim",parameters:[{name:"@expression",dataType:$data.String},{name:"chars",dataType:$data.String}]},rtrim:{dataType:$data.String,allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.ProjectionExpression],mapTo:"rtrim",parameters:[{name:"@expression",dataType:$data.String},{name:"chars",dataType:$data.String}]}},enumerable:!0,writable:!0},supportedBinaryOperators:{value:{equal:{mapTo:"=",dataType:"boolean",nullMap:" is null"},notEqual:{mapTo:"!=",
dataType:"boolean",nullMap:" is not null"},equalTyped:{mapTo:"=",dataType:"boolean"},notEqualTyped:{mapTo:"!=",dataType:"boolean"},greaterThan:{mapTo:">",dataType:"boolean"},greaterThanOrEqual:{mapTo:">=",dataType:"boolean"},lessThan:{mapTo:"<",dataType:"boolean"},lessThenOrEqual:{mapTo:"<=",dataType:"boolean"},or:{mapTo:"OR",dataType:"boolean"},and:{mapTo:"AND",dataType:"boolean"},add:{mapTo:"+",dataType:"number"},divide:{mapTo:"/"},multiply:{mapTo:"*"},subtract:{mapTo:"-"},modulo:{mapTo:"%"},orBitwise:{maptTo:"|"},
andBitwsise:{mapTo:"&"},"in":{mapTo:"in",dataType:"boolean"}}},supportedUnaryOperators:{value:{not:{mapTo:"not"},positive:{mapTo:"+"},negative:{maptTo:"-"}}},supportedSetOperations:{value:{filter:{},map:{},length:{},forEach:{},toArray:{},single:{},take:{},skip:{},orderBy:{},orderByDescending:{},first:{},include:{}},enumerable:!0,writable:!0},buildDbType_modifyInstanceDefinition:function(a,b){var c=function(b,d){var c;d?(c=JSON.parse(JSON.stringify(a[d])),c.kind=b.kind,c.name=b.name,c.notMapped=!1):
c=JSON.parse(JSON.stringify(b));c.dataType=Container.resolveType(b.dataType);c.type=c.dataType;c.key=!1;c.computed=!1;return c},d=function(a,b,c,d){var i={};i[a.name]=c;i[b.name]=d+"__"+c;return i};b.Associations&&b.Associations.forEach(function(b){var g=!1,f=b.FromType,h=b.ToType,i=b.ToPropertyName;b.ReferentialConstraint=b.ReferentialConstraint||[];if("*"==b.FromMultiplicity&&"0..1"==b.ToMultiplicity||"0..1"==b.FromMultiplicity&&"1"==b.ToMultiplicity)f=b.ToType,h=b.FromType,i=b.FromPropertyName,
g=!0;f.memberDefinitions.getPublicMappedProperties().filter(function(a){return a.key}).forEach(function(j){g&&(a[i+"__"+j.name]=c(j,i));b.ReferentialConstraint.push(d(f,h,j.name,i))},this)},this);b.ComplexTypes&&b.ComplexTypes.forEach(function(b){b.ReferentialConstraint=b.ReferentialConstraint||[];b.ToType.memberDefinitions.getPublicMappedProperties().forEach(function(g){a[b.FromPropertyName+"__"+g.name]=c(g);b.ReferentialConstraint.push(d(b.ToType,b.FromType,g.name,b.FromPropertyName))},this)},this)},
buildDbType_generateConvertToFunction:function(a){return function(b){var c=new a.PhysicalType;c.entityState=b.entityState;a.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(a){c[a.name]=b[a.name]},this);a.Associations&&a.Associations.forEach(function(a){if("*"==a.FromMultiplicity&&"0..1"==a.ToMultiplicity||"0..1"==a.FromMultiplicity&&"1"==a.ToMultiplicity){var e=b[a.FromPropertyName];void 0!==e&&a.ReferentialConstraint.forEach(function(b){c[b[a.From]]=null!==e?e[b[a.To]]:
null},this)}},this);a.ComplexTypes&&a.ComplexTypes.forEach(function(a){var e=b[a.FromPropertyName];void 0!==e&&a.ReferentialConstraint.forEach(function(b){c[b[a.From]]=null!==e?e[b[a.To]]:null},this)},this);return c}},initializeStore:function(a){a=$data.typeSystem.createCallbackSetting(a);this.context._storageModel.forEach(function(a){this.SqlCommands.push(this.createSqlFromStorageModel(a)+" ")},this);var b=this._createSqlConnection(),c=this;b.createCommand("SELECT * FROM sqlite_master WHERE type = 'table'",
...
else{var a=f.shift().map(function(a){var b=g.context._storageModel.getStorageModel(a.data.getType()).PhysicalType;a.physicalData=b.convertTo(a.data);return a},this);g.saveIndependentItems(a,c,{success:function(){g.postProcessItems(a);e()},error:d.error})}}var g=this,f=[].concat(b);e()},saveIndependentItems:function(a,b,c){function d(a,b){var c=[],d=[];b.forEach(function(a,b){if(a&&(a.query&&(c[b]=a.query),a.param))d[b]=a.param});return a.createCommand(c,d)}var e=this,g=a.map(function(a){return e.saveEntitySet(a)}),
...
"](",c="",d="",e=[];a.physicalData.constructor.memberDefinitions.getPublicMappedProperties().forEach(function(b){0<c.length&&","!=c[c.length-1]&&(c+=",",d+=",");var f=b.name;if(void 0!==a.physicalData[f]&&b.dataType&&(!b.dataType.isAssignableTo||b.dataType.isAssignableTo&&!b.dataType.isAssignableTo($data.EntitySet))){d+="?";c+="["+f+"]";var h=a.data.getType().memberDefinitions.getMember(b.name);h&&h.converter&&h.converter[this.providerName]&&"function"==typeof h.converter[this.providerName].toDb?
e.push(h.converter[this.providerName].toDb(a.physicalData[f],h,this.context,h.dataType)):e.push(this.fieldConverter.toDb[Container.resolveName(b.dataType)](a.physicalData[f]))}},this);1>e.length&&Guard.raise(new Exception("None of the fields contain values in the entity to be saved."));","==c[c.length-1]&&(c=c.slice(0,c.length-1));","==d[d.length-1]&&(d=d.slice(0,d.length-1));return{query:b+(c+") VALUES("+d+");"),param:e}},save_reloadSavedEntity:function(a,b){return{query:"SELECT * FROM "+b+" WHERE rowid=?",
param:[a]}},createSqlFromStorageModel:function(a){(void 0===a||null===a||void 0===a.PhysicalType)&&Guard.raise("StorageModel not contains physical entity definition");var b=0,c=0;a.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(a){a.key&&b++;a.computed&&c++},this);1===c&&1<b&&Guard.raise(new Exception("Do not use computed field with multiple primary key!"));1<c&&1<b&&Guard.raise(new Exception("Do not use multiple computed field!"));var d="CREATE TABLE IF NOT EXISTS ["+
a.TableName+"] (",e=",PRIMARY KEY (";a.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(b,f){0<f&&!d.match(", $")&&!d.match("\\($")&&(d+=", ");d+=this.createSqlFragmentFromField(b,1===c,a);0===c&&b.key&&(14<e.length&&!e.match(", $")&&(e+=", "),e+="["+b.name+"]")},this);d.match(", $")&&(d=d.substr(0,d.length-2));0===c&&14<e.length&&(d+=e+")");return d+=");"},createSqlFragmentFromField:function(a,b,c){return"schemaCreate"in a&&a.schemaCreate?a.schemaCreate(a):(new this.FieldTypeBuilder(a,
this,b,c)).build()},FieldTypeBuilder:function(a,b,c,d){this.fieldDef="";this.fld=a;this.provider=b;this.parsePk=c;this.entitySet=d;this.build=function(){switch(Container.resolveType(this.fld.dataType)){case $data.String:case $data.Guid:case "text":case "string":this.buildFieldNameAndType("TEXT");break;case $data.Boolean:case $data.Integer:case "bool":case "boolean":case "int":case "integer":this.buildFieldNameAndType("INTEGER");break;case $data.Number:case $data.Date:case "number":case "datetime":case "date":this.buildFieldNameAndType("REAL");
...
c}},null);
$C("$data.sqLite.ExpressionMonitor",$data.Expressions.EntityExpressionVisitor,null,{constructor:function(a){this.Visit=function(b,c){var d=b,e;if(this.canVisit(b)){a.VisitExpressionNode&&a.VisitExpressionNode.apply(a,arguments);e="Visit"+b.getType().name;e in a&&(d=a[e].apply(a,arguments))}var g=arguments;d!==b&&(g=[d,c]);d=$data.Expressions.EntityExpressionVisitor.prototype.Visit.apply(this,g);g=[d,c];if(this.canVisit(d)){var f=d.getType().name;a.MonitorExpressionNode&&a.MonitorExpressionNode.apply(a,g);
e="Monitor"+f;e in a&&a[e].apply(a,g);a.MutateExpressionNode&&a.MutateExpressionNode.apply(a,g);e="Mutate"+f;e in a&&(d=a[e].apply(a,g))}return d};this.VisitIncludeExpression=function(b,c){var d=this.Visit(b.source,c);a.isMapped=true;var e=this.Visit(b.selector,c);a.isMapped=false;return d!==b.source||e!==b.selector?Container.createIncludeExpression(d,e):b};this.VisitProjectionExpression=function(b,c){var d=this.Visit(b.source,c);a.isMapped=true;var e=this.Visit(b.selector,c);a.isMapped=false;if(d!==
